  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: Container(
        ...
        decoration: BoxDecoration(gradient: AppColors.kMidnightDepths),
        child: Column(
          ...
          children: [
            ...
            SizedBox(height:10),
            AppText(text: AppStrings.buildConsistencyDayAtATime, fontSize: 12, fontWeight: FontWeight.w400,color: AppColors.kSlateBlue,),
          ],
        ),
      ),
    );
